...
<div class="form-group <?php if(form_error('username') != false) echo "has-error"; ?>">
    <label class="control-label" for="username"><?php echo $this->lang->line('authentication_fields_username'); ?></label>
    <input type="text" class="form-control" name="username" value="<?php echo set_value('username'); ?>"
           id="username">
</div>
<div class="form-group <?php if(form_error('firstName') != false) echo "has-error"; ?>">
    <label class="control-label" for="firstName"><?php echo $this->lang->line('authentication_fields_firstname'); ?></label>
...
<div class="form-group <?php if(form_error('lastName') != false) echo "has-error"; ?>">
    <label class="control-label" for="lastName"><?php echo $this->lang->line('authentication_fields_lastname'); ?></label>
...
<div class="form-group <?php if(form_error('password') != false) echo "has-error"; ?>">
    <label class="control-label" for="password"><?php echo $this->lang->line('authentication_fields_password'); ?></label>
    <input type="password" class="form-control" name="password" id="password">
</div>
<div class="form-group <?php if(form_error('passwordconfirmation') != false) echo "has-error"; ?>">
    <label class="control-label" for="passwordconfirmation" ><?php echo $this->lang->line('authentication_fields_passwordconfirmation'); ?></label>
    <input type="password" class="form-control" name="passwordconfirmation" id="passwordconfirmation">
</div>
<div class="form-group">
    <input type="submit" class="btn btn-primary" value="<?php echo $this->lang->line('authentication_general_register'); ?>"/>
